...
parser.add_argument('--data_json', type=str, default='/opt/dataset/pheme_gpt_cleaned.json',
                    help='数据文件json路径')
parser.add_argument('--image_folder', type=str, default='/opt/dataset/phemepic/',
                    help='图片文件夹路径')
...
parser.add_argument('--swin_model_dir', type=str, default='/opt/swin/',
                    help='Swin模型所在路径')
parser.add_argument('--gpt_csv_file', type=str, default='/opt/genpheme.csv',
